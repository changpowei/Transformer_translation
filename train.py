...
def main():
    ...
    parser.add_argument('-src_data', required=False, default='data/english.txt')
    parser.add_argument('-trg_data', required=False, default='data/french.txt')
    parser.add_argument('-src_lang', required=False, default='en')
    parser.add_argument('-trg_lang', required=False, default='fr')
    parser.add_argument('-no_cuda', action='store_true')
    parser.add_argument('-SGDR', action='store_true')
    parser.add_argument('-epochs', type=int, default=10)
    parser.add_argument('-d_model', type=int, default=512)     #特徵的維度，必須是head的數量
    ...
    parser.add_argument('-max_strlen', type=int, default=80)    #一個句子最多能有幾個字
